...
const AdminLayout = () => {
  return (
    <div className="mx-auto max-w-7xl px-5 py-10 sm:px-8">
      <h1 className="font-display text-3xl font-semibold text-forest-800 dark:text-sand-50">Admin Dashboard</h1>
      <p className="mt-1 font-body text-sm text-ink/60 dark:text-sand-100/60">Manage rooms, bookings and view performance at a glance.</p>
